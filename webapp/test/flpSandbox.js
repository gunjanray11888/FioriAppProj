		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#APIIntegrationTest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"APIIntegrationTest-display": {
								"semanticObject": "APIIntegrationTest",
								"action": "display",
								"description": "App to test Business API Integration",
								"title": "API Integration Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gj.api.test.APITestProj",
									"url": sap.ui.require.toUrl("gj/api/test/APITestProj")
								}
							}
						}
					}
