sap.ui.define([
	...
	return Opa5.extend("gj.api.test.APITestProj.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["gj/api/test/APITestProj/localService/mockserver"], function (mockserver) {
